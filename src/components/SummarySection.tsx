        ...
        <AnimatePresence>
            {isVisible && (
                <motion.section
                    ...
                    className="relative z-10 bg-gradient-to-t from-slate-900 to-transparent border-t border-white/5 flex flex-col items-center group/summary overflow-hidden"
                >
                    <div className="py-6 flex flex-col items-center w-full">
                        ...
                        <motion.p
                            ...
                            className="max-w-3xl mx-auto text-slate-300 mb-6 leading-relaxed text-base px-4 text-center"
                        >
                        ...
                        <footer className="p-2 border-t border-white/5 w-full flex flex-col items-center gap-1 bg-black/50">
